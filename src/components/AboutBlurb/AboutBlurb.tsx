            ...
            <div className={styles.row}> 
                ...
                <div className={styles.imageCol}>
                    ...
                    <div className={styles.links}>
                        ...
                        <span>
                            {`on `}
                            <a href="https://www.linkedin.com/in/rileyhgrant/" target="_blank" rel="noreferrer">LinkedIn</a>
                        </span>
                        <span>
                            {`on `}
                            <a href="https://github.com/rileyhgrant" target="_blank" rel="noreferrer">GitHub</a>
                        </span>
                        <span>
                            {`via `}
                            <a href="mailto: grantrileyh@gmail.com" target="_blank" rel="noreferrer">Email</a>
                        </span>
                        <span>
                            {`see my `}
                ...
                <div className={styles.textCol}>
                    ...
                    <div dangerouslySetInnerHTML={{ __html: props.abtData.contentHtml }} />
